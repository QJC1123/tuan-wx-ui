					...
					<uni-card margin="0">
						<view class="example" style="padding-left: 0px;padding-right: 0px;padding-top: 3px;padding-bottom: 10px; zoom: 1.2;">
							...
							<uni-forms ref="baseForm" :modelValue="baseFormData" class="form-x" >
								...
								<view style="padding-bottom: 13px;">
									<view style="padding-bottom:3px;padding-left: 5px;"><span style="">申报人</span></view>
									<uni-row ><uni-easyinput v-model="baseFormData.name" placeholder="请选择姓名"/></uni-row>
								</view>
								<view style="padding-bottom: 13px;">
									<view style="padding-bottom:3px;padding-left: 5px;"><span style="">联系方式</span></view>
									<uni-row ><uni-easyinput v-model="baseFormData.name" placeholder="请输入联系方式"/></uni-row>
								...
								<view style="padding-bottom: 13px;">
									<view style="padding-bottom:3px;padding-left: 5px;"><span style="">设备名称</span></view>
									<uni-row ><uni-easyinput v-model="baseFormData.name" placeholder="请选择设备名称"/></uni-row>
								</view>
							</uni-forms>
						</view>
						<view class="example" style="padding-left: 0px;padding-right: 0px;padding-top: 3px;padding-bottom: 10px;zoom: 1.2;">
							...
							<uni-forms ref="baseForm" :modelValue="baseFormData" class="form-x" >
								...
								<view style="padding-bottom: 13px;">
									<view style="padding-bottom:3px;padding-left: 5px;"><span style="">上传图片</span></view>
